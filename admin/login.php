...
$sql = $db->prepare("select *from admin where ad_usarname=? and ad_password=?");
$sql->execute([$usarname, $password]);
$num=$sql->rowCount();
if($num>0){
  $_SESSION['user']=$usarname;  
echo   header('Location:section.php');
die;
}
else{
    ...
    <div class="card-body login-card-body">
      ...
      <form  method="POST">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="usarname" required placeholder="Usarname">
